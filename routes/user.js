...
const {register,login,forgotPassword,verifyToken,verifyEmail, adhaarcard, updateProfile, updateContacts,allusers,createsos, activepin, falsesos, safesos} =require("../controller/userController")
